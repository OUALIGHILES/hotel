...
-- Make sure the properties and units tables exist (based on existing schema)
-- Properties table (from existing schema)
...
-- Units/Rooms table (from existing schema)
...
-- Triggers to update the updated_at timestamp for all tables
